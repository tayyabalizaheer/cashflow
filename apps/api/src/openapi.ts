export const openApiDocument = {
  ...
  paths: {
    ...
    "/user-currencies": { get: { summary: "List user currencies" }, post: { summary: "Add a user currency" } },
    "/categories": { get: { summary: "List expense categories" }, post: { summary: "Create expense category" } },
    "/expenses": { get: { summary: "List expenses" }, post: { summary: "Create expense setup" } },
    "/expenses/{expenseId}/transactions": { post: { summary: "Create expense transaction" } },
    ...
    "/expense-purposes": { get: { summary: "List previous transaction purposes" } },
    "/loans": { get: { summary: "List loan people" }, post: { summary: "Create loan person" } },
    "/loans/{loanId}": { get: { summary: "Get loan person ledger" }, put: { summary: "Update loan person" } },
    "/loans/share/{shareId}": { get: { summary: "Get loan by short share id" } },
    "/public/loans/{shareId}": { get: { summary: "Get public shared loan ledger", security: [] } },
    "/loan-purposes": { get: { summary: "List previous loan transaction purposes" } },
    "/loans/{loanId}/transactions": { post: { summary: "Create loan credit or debit transaction" } },
    "/loans/{loanId}/transactions/{transactionId}": { put: { summary: "Update loan transaction" } },
    ...
    "/sync/bootstrap": { get: { summary: "Fetch all owner-scoped data for local SQLite bootstrap" } },
    "/sync/summary": { get: { summary: "Count online records before local restore" } },
    "/sync/status": { get: { summary: "Get sync queue status" } },
    "/sync/push": { post: { summary: "Queue client operations for server sync" } },
    "/trash": { get: { summary: "List archived records" } },
    "/trash/{type}/{id}/restore": { post: { summary: "Restore an archived record" } },
    "/trash/{type}/{id}": { delete: { summary: "Permanently delete an archived record" } },
